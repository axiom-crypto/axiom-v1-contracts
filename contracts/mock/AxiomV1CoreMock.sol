...
contract AxiomV1CoreMock is IAxiomV1, AxiomV1Access {
    ...
    function __AxiomV1Core_init(address guardian, address prover) internal onlyInitializing {
        __AxiomV1Access_init();
        __AxiomV1Core_init_unchained(guardian, prover);
    }

    /// @notice Initializes the contract without calling parent contract initializers.
    function __AxiomV1Core_init_unchained(address guardian, address prover) internal onlyInitializing {

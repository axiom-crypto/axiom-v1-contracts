...
import {BLOCK_BATCH_DEPTH} from "../contracts/libraries/configuration/AxiomV1Configuration.sol";

contract MerkleTreeTest is Test {
    using {MerkleTree.merkleRoot} for bytes32[128];

    function testEmptyMerkleRoots() public {
        vm.pauseGasMetering();
    ...
    function testMerkleRootValue() public pure {
